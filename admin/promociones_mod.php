...
$.get("publicado.php", { publicado: c, id:id },
  function(data){
...
<thead>
   ...
   <tr>
     ...
     <th width="13%" data-sort-ignore="true">Publicado</th>
  ...
  <?php do { ?>
    <tr id="<?php echo $row_promociones['Id']; ?>">
      ...
      <td style="padding-left:20px;" ><input class="publi" type="checkbox" name="publi" rel="<?php echo $row_promociones['Id']; ?>" <?php if($row_promociones['publicado']=='Y'){ echo ' checked '; } ?> /></td>
