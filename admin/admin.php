...
$(document).ready(function() {
    ...
    <header class="cd-main-header">
		<a href="admin.php" class="cd-logo" style="text-align:left; background-color:black;" ><img src="../KER_BELGRANO_Website/LOGOS/Home_Ker_Belgrano_logo.png" width="90" alt="Logo"></a>
