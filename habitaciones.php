<?php include("header.php");?>
        ...
        <div class="habitaciones">
	        ...
	        <div class="blanco"><!--  -->
		        <div class="col-md-6">
			        <h1>Standard</h1>
			        <p>Habitación de 20 m2, amplia y cómoda,
es una excelente opción para estadías breves y prolongadas. Se pueden armar King Size o Twin Size.


</p>
			        <a href="habitaciones_standard.php">RESERV&Aacute;</a>
		        </div>
	        ...
	        <div class="col-md-6 hidden-md hidden-lg hidden-sm">
			        <h1>Superior</h1>
			        <p>Habitación de 30 m2, moderna y cómoda. Se pueden armar King Size o Twin Size y admite cama adicional. Es una excelente opción para estadías prolongadas dada su amplitud y detalles.
</p>
			        <a href="habitaciones_superior.php">RESERV&Aacute;</a>
		        </div>
	        <div class="col-md-6 nopad">
			        <div class="carousel1">
				        <div class="item"><img src="KER_BELGRANO_Website/HABITACIONES/KER_BELGRANO_HABITACIONES_superior_01.jpg" alt="KER_BELGRANO_HABITACIONES_standard_01" /></div>
				        <div class="item"><img src="KER_BELGRANO_Website/HABITACIONES/KER_BELGRANO_HABITACIONES_superior_02.jpg" alt="KER_BELGRANO_HABITACIONES_standard_01" /></div>
				        <div class="item"><img src="KER_BELGRANO_Website/HABITACIONES/KER_BELGRANO_HABITACIONES_superior_03.jpg" alt="KER_BELGRANO_HABITACIONES_standard_01" /></div>
			        </div>
		        </div>
	        ...
	        <div class="blanco"><!--  -->
		        <div class="col-md-6">
			        <h1>Executive</h1>
			        <p>Habitación de 35 m2, se pueden armar King Size o Twin Size y admite cama adicional. Comodidad y confort en habitaciones amplias y modernas, con tecnología que completa un espacio ideal para el bienestar del huésped.
</p>
			        <a href="habitaciones_executive.php">RESERV&Aacute;</a>
		        </div>
		        <div class="col-md-6 nopad">
			        <div class="carousel1">
				        <div class="item"><img src="KER_BELGRANO_Website/HABITACIONES/KER_BELGRANO_HABITACIONES_executive_01.jpg" alt="KER_BELGRANO_HABITACIONES_standard_01" /></div>
				        <div class="item"><img src="KER_BELGRANO_Website/HABITACIONES/KER_BELGRANO_HABITACIONES_executive_02.jpg" alt="KER_BELGRANO_HABITACIONES_standard_01" /></div>
				        <div class="item"><img src="KER_BELGRANO_Website/HABITACIONES/KER_BELGRANO_HABITACIONES_executive_03.jpg" alt="KER_BELGRANO_HABITACIONES_standard_01" /></div>
			        </div>
		        </div>
	        ...
	        <div class="col-md-6 nopad">
		        ...
		        <div class="col-md-6">
			        <h1>Suite</h1>
			        <p>Cómoda habitación de 40 m2.
Se pueden armar King Size o Twin Size; ideal para distenderse o trabajar, y convertir la estadía en parte de una experiencia diferente
</p>
			        <a href="habitaciones_suite.php" target="_blank">RESERV&Aacute;</a>
		        </div>
		        <div class="clear"></div>
	        </div><!--  -->
