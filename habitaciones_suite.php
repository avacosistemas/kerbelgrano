<?php include("header.php");?>
        ...
        <div class="habitaciones_detalle">
	        <div class="container">
		        <div class="col-md-12"><h1>HABITACI&Oacute;N <span>SUITE</span></h1></div>
	        <div class="col-md-8 borde">
		        <div class="carousel1">
			        ...
			        <h2>HABITACI&Oacute;N <span>SUITE</span></h2>
		        <p>
			        Cómoda habitación de 40 m2.
...
· Grupo electrógeno<br>
        ...
        <form action="https://reservations.travelclick.com/74787#/guestsandrooms" method="get" target="_blank">
	        ...
	        <img src="KER_BELGRANO_Website/KER_BELGRANO_Habitaciones_Fichas_Suite.jpg" alt="01Standard_Banner_inferior_Standard" class="foto img-responsive">
        </div>
