	...
	<?php include("protocolo_covid.php");?>  	
        ...
        <div class="habitaciones_detalle">
	        ...
	        <div class="col-md-8 borde">
		        ...
		        <p>
			        Habitación de 35 m2, se pueden armar King Size o Twin Size y admite cama adicional. Comodidad y confort en habitaciones amplias y modernas, con tecnología que completa un espacio ideal para el bienestar del huésped.
...
· Grupo electrógeno<br>
        ...
        <form action="https://reservations.travelclick.com/74787#/guestsandrooms" method="get" target="_blank">
	        ...
	        <img src="KER_BELGRANO_Website/KER_BELGRANO_Habitaciones_Fichas_Executive.jpg" alt="01Standard_Banner_inferior_Standard" class="foto img-responsive">
        </div>
