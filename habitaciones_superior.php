<?php include("header.php");?>
        ...
        <div class="habitaciones_detalle">
	        ...
	        <div class="col-md-8 borde">
		        ...
		        <p>
			        Habitación de 30 m2, moderna y cómoda. Se pueden armar King Size o Twin Size y admite cama adicional.
Es una excelente opción para estadías prolongadas dada su amplitud y detalles.
...
· Grupo electrógeno<br>
        ...
        <form action="https://reservations.travelclick.com/74787#/guestsandrooms" method="get" target="_blank">
	        ...
	        <img src="KER_BELGRANO_Website/KER_BELGRANO_Habitaciones_Fichas_Superior.jpg" alt="01Standard_Banner_inferior_Standard" class="foto img-responsive">
        </div>
