...
<?php $i=0; do{ $i++;?>            
		        <div class="col-md-4">
			        ...
			        <a href="https://reservations.travelclick.com/73729?room=Tipo+de+habitaci%C3%B3n&DateIn=&DateOut=&Adults=Huespedes&languageid=2#/guestsandrooms" target="_blank">VER M&Aacute;S</a>
			        <?php } else {?>
