...
?>
        ...
        <div class="stay">
	        <div class="col-md-6">
		        ...
		        <h1>Sweet home</h1>
		        <p>Ker Belgrano ofrece 27 cálidas y confortables habitaciones pensadas para satisfacer las necesidades de aquellas personas que viajen por placer, por negocios y congresos, que se realicen tanto en la Ciudad Autónoma, como en Provincia de Buenos Aires. Está ubicado, en el corazón del Barrio de Belgrano, uno de los barrios residenciales más pintorescos y corporativos de la Ciudad, rodeado de cantidad de viejas e importantes casonas señoriales, la mayoría típicas de fines del siglo XIX.
</p>
		        <h2><span>Explore rooms & suites</span></h2>
		        <a href="KER_BELGRANO_FactSheets_Frente-Dorso_BAJA.pdf" target="_blank" class="botonfact">DESCARGAR FACTSHEET</a>
		        <div class="clear"></div>
		        <a href="https://reservations.travelclick.com/74787?languageid=2" target="_blank">RESERV&Aacute;</a>
		        </div>
	        </div>
        ...
        <div class="trip">
	        ...
	        <div class="col-md-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.6s">
		       ...
		       <div id="TA_selfserveprop305" class="TA_selfserveprop"><ul id="07vCHfafB3" class="TA_links uJejzeX0"><li id="rat0mb" class="o65BCD0eRES"><a target="_blank" href="https://www.tripadvisor.com.ar/Hotel_Review-g312741-d1735978-Reviews-Ker_Belgrano_Apart_Spa-Buenos_Aires_Capital_Federal_District.html"><img src="https://www.tripadvisor.com.ar/img/cdsi/img2/branding/150_logo-11900-2.png" alt="TripAdvisor"/></a></li></ul></div><script async src="https://www.jscache.com/wejs?wtype=selfserveprop&amp;uniq=305&amp;locationId=1735978&amp;lang=es_AR&amp;rating=true&amp;nreviews=5&amp;writereviewlink=true&amp;popIdx=true&amp;iswide=false&amp;border=true&amp;display_version=2" data-loadtrk onload="this.loadtrk=true"></script>
	        </div>
	        <div class="clear"></div>
        </div>
...
<?php if($totalRows_promociones!=0){?>
  ...
  <div class="modal-body">
	<?php if($row_promociones['Id']==14 || $row_promociones['Id']==18){?>
